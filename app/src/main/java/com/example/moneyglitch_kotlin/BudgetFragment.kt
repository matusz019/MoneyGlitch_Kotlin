...
class BudgetFragment : Fragment() {
    ...
    private var categoryFilters = mutableSetOf<String>() // Keeps track of included categories
    private var allCategories = mutableSetOf<String>() // Stores all category names
    private var transactions = listOf<Transaction>() // Stores all transactions
    ...
    private fun loadTransactionData() {
        ...
        lifecycleScope.launch {
            db.dao.getTransactionsByType("expense").collect { fetchedTransactions ->
                ...
                // Initialize category filters with all categories selected
    ...
    private fun updatePieChart() {
        val filteredTransactions = transactions.filter { it.category in categoryFilters }
        ...
        // Set value formatter to show percentage
